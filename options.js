...
const HUB_INFO = {
  ...
  'Dubai/Oman': { location:'Dubai, UAE / Oman', desc:'The primary Middle East crude oil benchmark, traded on the Dubai Mercantile Exchange (DME). Used to price the majority of crude oil exports from the Persian Gulf to Asia. The Oman futures contract is the only physically delivered Middle East crude benchmark.', contract:'1,000 BBL', tick:'$0.01/BBL', hours:'DME: Sun-Fri', settlement:'Physical delivery (Oman)', seasonal:'Asian refinery demand peaks in Q4 pre-winter. Summer maintenance in Asia weakens demand. Monsoon season can disrupt tanker scheduling.', risks:'OPEC+ production policy, Strait of Hormuz geopolitical risk, Asian demand growth, competing benchmarks (Murban, ICE).', related:['Murban','Brent Dated','Basra Medium'] },
  'Murban': { location:'Abu Dhabi, UAE', desc:'Abu Dhabi\'s flagship light sweet crude grade, traded on ICE Futures Abu Dhabi (IFAD) since March 2021. Murban is gaining importance as a transparent, exchange-traded Middle East benchmark competing with Dubai/Oman.', contract:'1,000 BBL', tick:'$0.01/BBL', hours:'IFAD: Sun-Fri', settlement:'Physical delivery (Fujairah)', seasonal:'Follows broader Middle East demand patterns. Asian petrochemical feedstock demand supports light sweet premium.', risks:'ADNOC production policy, IFAD liquidity development, competition with Dubai/Oman benchmark, Asian refinery margins.', related:['Dubai/Oman','Brent Dated','Tapis'] },
  'Urals': { location:'CIF Rotterdam / Augusta, Mediterranean', desc:'Russian export blend crude, a medium sour grade. Historically the dominant crude import into European refineries. Priced as a differential to Brent Dated, typically at a discount reflecting quality and geopolitical factors.', contract:'1,000 BBL (600 Kbbl cargo)', tick:'$0.01/BBL', hours:'OTC 24/7', settlement:'Financial (Platts CIF)', seasonal:'European refinery maintenance in spring/fall affects demand. Winter heating oil demand supports medium sour grades.', risks:'EU/G7 sanctions and price cap, shipping/insurance restrictions, Russian production declines, India/China rerouting flows, tanker dark fleet.', related:['Brent Dated','Dubai/Oman','Basra Medium'] },
  'Bonny Light': { location:'Bonny Island, Nigeria', desc:'Premium West African light sweet crude grade (API ~33, sulfur ~0.14%). Highly valued by European and Asian refineries for its low sulfur content and high gasoline/naphtha yields. Key benchmark for the West African crude market.', contract:'1,000 BBL (950 Kbbl cargo)', tick:'$0.01/BBL', hours:'OTC 24/7', settlement:'Financial (Platts Dated)', seasonal:'European refinery demand drives seasonal patterns. Atlantic Basin arbitrage economics vs US Gulf grades.', risks:'Nigerian production outages (pipeline vandalism, theft), OPEC quota compliance, competing US light sweet exports, refinery demand shifts.', related:['Brent Dated','LLS','Tapis'] },
  'Tapis': { location:'Terengganu, Malaysia', desc:'Malaysian light sweet crude (API ~44, sulfur ~0.04%), the premium Asia-Pacific crude benchmark. One of the lightest and sweetest crudes globally, commanding a significant premium for naphtha-rich yields.', contract:'1,000 BBL', tick:'$0.01/BBL', hours:'OTC 24/7', settlement:'Financial (Platts APAG)', seasonal:'Asian petrochemical demand peaks drive seasonal premium. Chinese refinery runs and Japanese naphtha imports influence pricing.', risks:'Malaysian production decline, competing light sweet grades, Asian refinery configuration shifts, petrochemical feedstock economics.', related:['Dubai/Oman','Murban','Daqing'] },
  'Basra Medium': { location:'Basra, Iraq (Al Basrah Oil Terminal)', desc:'Iraq\'s primary export crude grade from southern fields. A medium sour crude that is one of the most heavily traded grades in the global market due to Iraq\'s large export volumes (~3.5 MMbbl/d).', contract:'1,000 BBL (2 MMbbl cargo)', tick:'$0.01/BBL', hours:'OTC 24/7', settlement:'Financial (OSP-based)', seasonal:'OPEC quota adjustments, Asian refinery demand cycles, summer vs winter crude quality nominations.', risks:'Iraqi political instability, OPEC+ compliance, Basra channel congestion, Kurdish export disputes, infrastructure maintenance.', related:['Dubai/Oman','Urals','Mars Sour'] },
  'Daqing': { location:'Daqing, Heilongjiang, China', desc:'China\'s largest and most iconic oilfield, producing a medium-sweet waxy crude (API ~32). Daqing is a key domestic benchmark reflecting Chinese refinery economics and state-controlled pricing dynamics.', contract:'1,000 BBL', tick:'$0.01/BBL (CNY)', hours:'Shanghai INE / OTC', settlement:'Financial', seasonal:'Chinese refinery maintenance (spring/fall), strategic petroleum reserve builds, Lunar New Year demand shifts.', risks:'Mature field decline rates, Chinese demand outlook, state pricing controls, competition from imported crudes, INE futures development.', related:['Tapis','Dubai/Oman','Murban'] },
  'RBOB Gasoline': { location:'New York Harbor (NYMEX delivery)', desc:'Reformulated Blendstock for Oxygenate Blending — the primary US gasoline futures benchmark. Trades on NYMEX as the front-month RB contract and reflects wholesale gasoline prices at the NY Harbor delivery point.', contract:'42,000 gal (1,000 BBL)', tick:'$0.0001/gal ($4.20)', hours:'NYMEX 18:00-17:00 ET (Sun-Fri)', settlement:'Physical (NY Harbor)', seasonal:'Strong seasonal pattern: prices rise Mar-May (summer blend switchover, driving season), peak Jun-Aug, decline Sep-Oct (winter blend). RVP spec changes drive refinery economics.', risks:'Refinery outages, RFS/RIN costs, ethanol mandates, driving demand, hurricane disruptions to Gulf Coast refining.', related:['WTI Cushing','ULSD Diesel','Brent Dated'] },
  'ULSD Diesel': { location:'New York Harbor (NYMEX delivery)', desc:'Ultra-Low Sulfur Diesel — the primary US distillate/heating oil futures benchmark (NYMEX HO contract). Represents wholesale diesel and heating oil prices. Key indicator of industrial and transportation demand.', contract:'42,000 gal (1,000 BBL)', tick:'$0.0001/gal ($4.20)', hours:'NYMEX 18:00-17:00 ET (Sun-Fri)', settlement:'Physical (NY Harbor)', seasonal:'Winter heating demand (Oct-Mar) supports prices in the Northeast. Summer trucking/harvest season adds demand. Crack spreads widen during supply disruptions.', risks:'Cold weather spikes, refinery maintenance, IMO bunker fuel spec changes, trucking demand, European diesel imports/exports.', related:['WTI Cushing','RBOB Gasoline','Brent Dated'] },
  'Jet Fuel': { location:'US Gulf Coast / New York Harbor', desc:'Aviation turbine fuel (Jet A / Jet A-1) — priced as a differential to ULSD diesel or as a standalone Platts assessment. Jet fuel demand is a key barometer of global economic activity and aviation recovery.', contract:'42,000 gal (1,000 BBL)', tick:'$0.0001/gal', hours:'OTC / Platts MOC', settlement:'Financial (vs ULSD)', seasonal:'Peak summer travel season (Jun-Aug), holiday travel (Nov-Dec, Mar). Shoulder seasons see lower demand. SAF mandates increasingly affect pricing.', risks:'Airline demand shocks, pandemic risk, SAF blending mandates, refinery yield optimization, geopolitical flight route disruptions.', related:['ULSD Diesel','RBOB Gasoline','Brent Dated'] },
  'MichCon': { location:'Detroit, Michigan (Michigan Consolidated)', desc:'MichCon Citygate is a major natural gas pricing point serving the Detroit metropolitan area and southeastern Michigan. Operated historically by Michigan Consolidated Gas Company (now DTE Energy). Key demand center for Midwest heating and industrial gas.', contract:'2,500 MMBtu', tick:'$0.001/MMBtu', hours:'OTC / ICE', settlement:'Financial', seasonal:'Strong winter heating demand (Dec-Feb) drives premium over Henry Hub. Summer basis typically narrows. Polar vortex events cause extreme spikes.', risks:'Extreme cold events, storage levels, Midwest pipeline capacity, competition with Dawn Hub for supply, industrial demand shifts.', related:['Chicago','Dawn','Henry Hub'] },
